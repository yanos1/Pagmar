...
public sealed class FallDownPostRendererFeature : ScriptableRendererFeature
{
    ...
    public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
    {
        ...
        FallDownPostVolumeComponent myVolume = VolumeManager.instance.stack?.GetComponent<FallDownPostVolumeComponent>();
